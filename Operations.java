...
public class Operations {
    ...
    public static void performOperation(String operation, double result1, double result2, String resultBase, Scanner scanner) {
        ...
        // Convert result to the specified base and display
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            double result1 = getNumber(scanner, "first");
            double result2 = getNumber(scanner, "second");

            String resultBase = getResultBase(scanner);

            performOperation(operation, result1, result2, resultBase, scanner);
        }
        scanner.close();
    }
    ...
    public static String getOperation(Scanner scanner) {
        ...
        while (true) {
            ...
            if (operation.matches("[1-4]|exit")) {
                break; // Valid operation selected
            } else {
    ...
    public static String getResultBase(Scanner scanner) {
        ...
        while (true) {
            ...
            // Corrected regex to match 2, 8, 10, or 16
