...
public class Constant {
    ...
    public String PROMPT_CORRECT_ANSWER = "Enter the correct answer (must be one of the options):";
    
    public String INVALID_ANSWER = "Invalid answer. Please enter one of the provided options.";
    
    public static String ASTERICS = "  *  ";
    ...
    public static String MARKS = "\t\t\tScore: ";
    ...
    public static String AVAILABLE_QUIZ = "Available quizes are : ";
     
    public static final String NO_QUIZ_AVAILABLE = "No quizzes available!";
    
    public static final String AVAILABLE_QUIZZES = "Available Quizzes:";
    
    public static final String PARTICIPANT_NAME_PROMPT = "Enter participant's name: ";
    
    public static final String QUIZ_END_PROMPT = "Do you want to end the quiz? (yes/no): ";
    
    public static final String RESULT_PROMPT = "Results of the quiz:";
    
    public static String DIFFICULTY_LEVEL = "Difficulty Levels of Questions:";
